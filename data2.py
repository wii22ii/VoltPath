...
max_energy_row = df.loc[df['Energy_kWh'].idxmax()]

print("Highest energy consumption was:")
print(f"Energy amount: {max_energy_row['Energy_kWh']:.2f} kWh")
print(f"Location: {max_energy_row['Location']}")
print(f"Date: {max_energy_row['Date']}")
print(f"Peak Time: {max_energy_row['PeakTime']}")