...
min_battery_row = df.loc[df['BatteryLevel_%'].idxmin()]

print("Location with the lowest battery level (most in need of energy):")
print(f"Battery Level: {min_battery_row['BatteryLevel_%']:.0f}%")
print(f"Location: {min_battery_row['Location']}")
print(f"Date: {min_battery_row['Date']}")
print(f"Peak Time: {min_battery_row['PeakTime']}")